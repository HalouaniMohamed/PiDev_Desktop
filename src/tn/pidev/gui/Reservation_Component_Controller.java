...
public class Reservation_Component_Controller implements Initializable {
    ...
    void valider(ActionEvent event) throws Exception {
     ...
     new Alert(Alert.AlertType.WARNING,"Pas de place disponible pour  cet evenement!",ButtonType.OK).show();
            ...
            Reservation r = new Reservation(Double.valueOf(_qunatite.getValue()).intValue(),_email.getText(),this.event);
    ...
    if (selectedFile != null) {
        ...
        Paragraph titre = new Paragraph("Reçu de reservation", fontTitre);
...
Paragraph lieu = new Paragraph("Lieu d'evenement: " + c.getE().getLieu_evenement()+".", font);
       ...
       Paragraph aa = new Paragraph("Un email de confirmation a été envoyé à votre adresse,veuillez imprimer ce reçu et merci. " , font1);
