...
//    }
    ...
    private void pdf(ActionEvent event) {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("mood.pdf"));

            document.open();

            Paragraph paragraph = new Paragraph("les moods");
           // paragraph.setAlignment(Element.ALIGN_CENTER);
            ...
            ObservableList<Mood> listeB = Moodview.getSelectionModel().getSelectedItems();

            pdfTable.addCell("UserID");
            pdfTable.addCell("MoodID");
             pdfTable.addCell("Mood");
              pdfTable.addCell("Description");

            for (Mood mood : listeB) {
//                pdfTable.addCell("ID");
//                pdfTable.addCell(String.valueOf(mood.getId()));

                pdfTable.addCell("userid");
                pdfTable.addCell(String.valueOf(mood.getUser_id()));
                 pdfTable.addCell("Moodid");
                pdfTable.addCell(String.valueOf(mood.getMood_id()));
                 pdfTable.addCell("Mood");
                pdfTable.addCell(mood.getMood());
                 pdfTable.addCell("description");
                pdfTable.addCell(mood.getDescription());
